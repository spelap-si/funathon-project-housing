...
::: {.callout-important title="If you want to fetch back final RF and GB model from S3" collapse="true"}
...
Save the RMSE for both models as `rmse_rf` and `rmse_gb`. 
...
These steps form the foundations of any rigorous model validation workflow, well done ! You can now have a look at [how to log a model](5-logging.qmd) to avoid being lost between different models and having to train again a model. 
